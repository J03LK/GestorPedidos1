...
public class GestorPedidos {
    ...
    public void procesarPedido (String nombreCliente, String emailCliente,
        ...
        double subtotal = 0;
        for (int $i=\theta$; i < nombres Productos.size(); i++) {
        }
        subtotal += precios Productos.get(i) * cantidades.get(i);
        ...
        try {
            ...
            writer.write(nombres Productos.get(i) + "x" + cantidades.get(i)
                    +"\$" + (precios Productos.get(i) cantidades.get(i)) + "\n");
